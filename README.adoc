...
For information about running BDD Tests, refer to https://github.com/hostilechild007/uprotocol-tck/blob/ulink_socket_python/BDD/README.adoc[BDD/README.adoc]
