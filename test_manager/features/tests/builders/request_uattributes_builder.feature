...
Feature: UAttributes Builder request()
  ...
  Scenario Outline: Testing UAttributes Builder's request()
    ...
    When sends "build_uattribute_request" request
    ...
    Then receives json with following set fields: 
      ...
      | priority                    | UPriority.UPRIORITY_CS1            | int                 |
      | type                        | UMessageType.UMESSAGE_TYPE_REQUEST | int                 |
      | ttl                         | 1000                               | int                 |
    ...
    Scenario Outline: Testing UAttributes Builder's requests() with dataset 2
    ...
    Scenario Outline: Testing UAttributes Builder's request() with additional parameters
    Given "<uE1>" creates data for "build_uattribute_request":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
  ...
  Scenario Outline: Testing UAttributes Builder's request() when proto attribute field is set to incorrect data type 0
    Given "<uE1>" creates data for "build_uattribute_request":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
  ...
  Scenario Outline: Testing UAttributes Builder's request() when proto attribute field is set to incorrect data type 1
    Given "<uE1>" creates data for "build_uattribute_request":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
  ...
  Scenario Outline: Testing UAttributes Builder's request() when proto attribute field is set to incorrect data type 2
    Given "<uE1>" creates data for "build_uattribute_request":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
  ...
  Scenario Outline: Testing UAttributes Builder's request() when proto attribute field is set to incorrect data type 3
    Given "<uE1>" creates data for "build_uattribute_request":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
  ...
  Scenario Outline: Testing UAttributes Builder's request() when proto attribute field is set to incorrect data type 4
    Given "<uE1>" creates data for "build_uattribute_request":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
  ...
  Scenario Outline: Testing UAttributes Builder's request() when proto attribute field is set to incorrect data type 5
    Given "<uE1>" creates data for "build_uattribute_request":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
  ...
  Scenario Outline: Testing UAttributes Builder's request() when proto attribute field is set to incorrect data type 6
    Given "<uE1>" creates data for "build_uattribute_request":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
      | source.resource.name        | name                          | str                 |
      | sink.authority.name         | vcu.someVin.veh.sample.gm.com | str                 |
  ...
  Scenario Outline: Testing UAttributes Builder's request() when proto attribute field is set to incorrect data type 7
    Given "<uE1>" creates data for "build_uattribute_request":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
      | source.resource.name        | name                          | str                 |
      | sink.authority.name         | vcu.someVin.veh.sample.gm.com | str                 |
  ...
  Scenario Outline: Testing UAttributes Builder's request() when proto attribute field is set to incorrect data type 8
    Given "<uE1>" creates data for "build_uattribute_request":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
      | source.resource.name        | name                          | str                 |
      | sink.authority.name         | vcu.someVin.veh.sample.gm.com | str                 |
  ...
  Scenario Outline: Testing UAttributes Builder's request() when attribute field is set to bad input value (-1000)
    Given "<uE1>" creates data for "build_uattribute_request":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
  ...
  Scenario Outline: Testing UAttributes Builder's request() with no source UUri set
    Given "<uE1>" creates data for "build_uattribute_request":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
      | priority                    | UPriority.UPRIORITY_CS1       | int                 |
  ...
  Scenario Outline: Testing UAttributes Builder's request() with no ttl set
    ...
    Then receives json with following set fields: 
      ...
      |                      | ERROR: "ttl" field must exist     | str                 |
  ...
  Scenario Outline: Testing UAttributes Builder's request() with wrong depth protobuf's field assignment 1
    Given "<uE1>" creates data for "build_uattribute_request":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
  ...
  Scenario Outline: Testing UAttributes Builder's request() with wrong depth protobuf's field assignment 4
    Given "<uE1>" creates data for "build_uattribute_request":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
