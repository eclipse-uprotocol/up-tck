...
Feature: UAttributes Builder notification()
  ...
  Scenario Outline: Testing UAttributes Builder's notification()
    ...
    Then receives json with following set fields: 
      ...
      | priority                    | UPriority.UPRIORITY_CS1            | int                 |
      | type                        | UMessageType.UMESSAGE_TYPE_NOTIFICATION | int                 |
      | ttl                         | 0                                  | int                 |
    ...
    Scenario Outline: Testing UAttributes Builder's notifications() with dataset 2
    Given "<uE1>" creates data for "build_uattribute_notification":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
    ...
    Scenario Outline: Testing UAttributes Builder's notification() with additional parameters
    Given "<uE1>" creates data for "build_uattribute_notification":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
  ...
  Scenario Outline: Testing UAttributes Builder's notification() when proto attribute field is set to incorrect data type 0
    Given "<uE1>" creates data for "build_uattribute_notification":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
  ...
  Scenario Outline: Testing UAttributes Builder's notification() when proto attribute field is set to incorrect data type 1
    Given "<uE1>" creates data for "build_uattribute_notification":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
  ...
  Scenario Outline: Testing UAttributes Builder's notification() when proto attribute field is set to incorrect data type 2
    Given "<uE1>" creates data for "build_uattribute_notification":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
  ...
  Scenario Outline: Testing UAttributes Builder's notification() when proto attribute field is set to incorrect data type 3
    Given "<uE1>" creates data for "build_uattribute_notification":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
  ...
  Scenario Outline: Testing UAttributes Builder's notification() when proto attribute field is set to incorrect data type 4
    Given "<uE1>" creates data for "build_uattribute_notification":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
  ...
  Scenario Outline: Testing UAttributes Builder's notification() when proto attribute field is set to incorrect data type 5
    Given "<uE1>" creates data for "build_uattribute_notification":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
  ...
  Scenario Outline: Testing UAttributes Builder's notification() when proto attribute field is set to incorrect data type 6
    Given "<uE1>" creates data for "build_uattribute_notification":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
      | source.resource.name        | name                          | str                 |
      | sink.authority.name         | vcu.someVin.veh.sample.gm.com | str                 |
  ...
  Scenario Outline: Testing UAttributes Builder's notification() when proto attribute field is set to incorrect data type 7
    Given "<uE1>" creates data for "build_uattribute_notification":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
      | source.resource.name        | name                          | str                 |
      | sink.authority.name         | vcu.someVin.veh.sample.gm.com | str                 |
  ...
  Scenario Outline: Testing UAttributes Builder's notification() when proto attribute field is set to incorrect data type 8
    Given "<uE1>" creates data for "build_uattribute_notification":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
      | source.resource.name        | name                          | str                 |
      | sink.authority.name         | vcu.someVin.veh.sample.gm.com | str                 |
  ...
  Scenario Outline: Testing UAttributes Builder's notification() when primitive attribute field is set to incorrect data type but works
    ...
    Scenario Outline: Testing UAttributes Builder's notification() with no source UUri set
    Given "<uE1>" creates data for "build_uattribute_notification":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
      | priority                    | UPriority.UPRIORITY_CS1       | int                 |
      | sink.authority.name         | nam                           | str                 |
  ...
  Scenario Outline: Testing UAttributes Builder's notification() with wrong depth protobuf's field assignment 1
    Given "<uE1>" creates data for "build_uattribute_notification":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
  ...
  Scenario Outline: Testing UAttributes Builder's notification() with wrong depth protobuf's field assignment 4
    Given "<uE1>" creates data for "build_uattribute_notification":
      | protobuf_field_names        | protobuf_field_values         | protobuf_field_type |
